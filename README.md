...
Frontend Setup
Use create-react-app to generate starter code for your your project. Follow the instructions on the create-react-app (Links to an external site.) site to get started.
